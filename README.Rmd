...
**Note:** to avoid errors with the Bioconductor dependencies, it is recommended to install them manually before installing *mitor* using the following commands:
